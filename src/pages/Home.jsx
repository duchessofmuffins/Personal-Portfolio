    ...
    return (
      <div>
        ...
        <div className="container">
          <div className="col-8">
            <h2>Hello!</h2>
              <p>My name is Alice Golter and I am an artist, musician, and entry level 
                developer living in Minneapolis, MN, USA. I graduated from the University of St. Thomas
